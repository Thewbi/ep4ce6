module usb(
	...
	// epc6
	clk, // USB3300 60Mhz clock
	rst,
	
	skrst // board reset
	//inclk0, // onboard clk (50 Mhz on the EPC6 Waveshare motherboard)
	...
	// reset
	input 			skrst; // board reset button
	...
	ulpi_sie Sie(
		...
		.ep1tx(ep1tx),
		.ep1txd(ep1txd),
		.setupdataactive(setupdataactive),
		.romaddr_i(romaddr_i),
		.romnum_i(romnum_i),
