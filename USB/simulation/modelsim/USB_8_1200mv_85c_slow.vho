...
SIGNAL \reset_performed~0_combout\ : std_logic;
SIGNAL \reset_performed~q\ : std_logic;
SIGNAL \RST_reg~0_combout\ : std_logic;
SIGNAL \RST_reg~q\ : std_logic;
...
-- Equation(s):
-- \counter~2_combout\ = (\Add0~16_combout\ & !\Equal0~10_combout\)
...
-- Equation(s):
-- \counter~1_combout\ = (\Add0~18_combout\ & !\Equal0~10_combout\)
...
-- Equation(s):
-- \counter~0_combout\ = (\Add0~20_combout\ & !\Equal0~10_combout\)
...
-- Equation(s):
-- \counter~4_combout\ = (\Add0~30_combout\ & !\Equal0~10_combout\)
...
-- Equation(s):
-- \counter~5_combout\ = (\Add0~32_combout\ & !\Equal0~10_combout\)
...
-- Equation(s):
-- \counter~6_combout\ = (!\Equal0~10_combout\ & \Add0~34_combout\)
...
-- Equation(s):
-- \Equal0~8_combout\ = (counter(24) & (counter(25) & (!counter(26) & !counter(27))))
...
-- Equation(s):
-- \Equal0~9_combout\ = (!counter(31) & (!counter(30) & (!counter(29) & !counter(28))))
...
-- Equation(s):
-- \Equal0~0_combout\ = (counter(8) & (counter(10) & (counter(9) & !counter(11))))
...
-- Equation(s):
-- \Equal0~1_combout\ = (!counter(7) & (!counter(5) & (!counter(6) & !counter(4))))
...
-- Equation(s):
-- \Equal0~2_combout\ = (!counter(2) & (!counter(0) & (!counter(1) & !counter(3))))
...
-- Equation(s):
-- \Equal0~7_combout\ = (counter(23) & (\Equal0~5_combout\ & (!counter(22) & \Equal0~6_combout\)))
...
-- Equation(s):
-- \led~8_combout\ = (\led[0]~reg0_q\ & ((!\Equal0~10_combout\))) # (!\led[0]~reg0_q\ & ((\Equal0~10_combout\) # (!\nrst~input_o\)))
...
\reset_performed~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \reset_performed~0_combout\ = (\reset_performed~q\ & (\nrst~input_o\)) # (!\reset_performed~q\ & ((\Equal0~10_combout\)))
...
PORT MAP (
	dataa => \nrst~input_o\,
	datac => \reset_performed~q\,
	datad => \Equal0~10_combout\,
	combout => \reset_performed~0_combout\);

-- Location: FF_X12_Y2_N3
reset_performed : dffeas
-- pragma translate_off
GENERIC MAP (
	is_wysiwyg => "true",
	power_up => "low")
...
PORT MAP (
	clk => \clkout~input_o\,
	d => \reset_performed~0_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \reset_performed~q\);

-- Location: LCCOMB_X12_Y2_N4
\RST_reg~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \RST_reg~0_combout\ = (\nrst~input_o\ & (\RST_reg~q\ & ((\reset_performed~q\) # (!\Equal0~10_combout\)))) # (!\nrst~input_o\ & ((\reset_performed~q\) # ((!\Equal0~10_combout\))))
...
PORT MAP (
	dataa => \nrst~input_o\,
	datab => \reset_performed~q\,
	datac => \RST_reg~q\,
	datad => \Equal0~10_combout\,
	combout => \RST_reg~0_combout\);
