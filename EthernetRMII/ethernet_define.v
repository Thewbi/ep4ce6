...
// VERSION_LENGTH + DIFFERENCE FIELD     2 bytes 
...
// UDP check sum (4 bytes) - E7 E8 EB 7F
`define ETHER_CHECKSUM_1         8'hE7
`define ETHER_CHECKSUM_2         8'hE8
`define ETHER_CHECKSUM_3         8'hEB
`define ETHER_CHECKSUM_4         8'h7F
